...
//COPY GMAIL REQUIREMENTS
gulp.task('copy-gmail', ['clean'], () => {
  return gulp.src('./gmail/**')
    .pipe(gulp.dest('./build'));
});
...
gulp.task('build', ['copy-manifest', 'copy-gmail', 'popup-js', 'popup-html', 'event-js', 'content-js']);
